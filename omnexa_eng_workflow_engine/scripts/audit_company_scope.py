#!/usr/bin/env python3
"""Audit company/branch scoping — omnexa_eng_workflow_engine."""
...
def run():
	...
	return {"ok": True, "app": "omnexa_eng_workflow_engine", "company": company, "branch": branch, "uses_session_context": bool(company)}
